				...
				<div class="col-sm-2">
				  ...
				  <div id="sidebar">
					<ul class="nav">
					  ...
					  <li>
						<a href="#">
						  <i class="zmdi zmdi-info-outline"></i> Wishlist
						</a>
					  </li>
					  <br>
					  <li>
						<a href="#">
						  <i class="zmdi zmdi-settings"></i> Checklist
						</a>
					  </li>
					  <br>
					  <li>
				...
				<div class="sideNav">
					<div class="bg-light border-right" id="sidebar-wrapper">
					  <div class="list-group list-group-flush">
						...
						<a href="#" class="list-group-item list-group-item-action bg-light">Upload</a>
						<a href="#" class="list-group-item list-group-item-action bg-light">Friends</a>
						<a href="#" class="list-group-item list-group-item-action bg-light">Wishlist</a>
						<a href="#" class="list-group-item list-group-item-action bg-light">Checklist</a>
